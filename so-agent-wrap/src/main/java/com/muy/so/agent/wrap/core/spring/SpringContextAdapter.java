package com.muy.so.agent.wrap.core.spring;

import com.muy.so.agent.wrap.core.bridge.ClassloaderBridge;
...
public class SpringContextAdapter {
    ...
    public static Object getBeanByName(String beanName) {
        return com.muy.so.agent.wrap.core.spring.SpringContextInnerContainer.isAgentLaunch()
            ? com.muy.so.agent.wrap.core.spring.SpringContextInnerContainer.getBeanByName(beanName)
    ...
    public static Object getBeanByType(String className) {
        return com.muy.so.agent.wrap.core.spring.SpringContextInnerContainer.isAgentLaunch()
            ? com.muy.so.agent.wrap.core.spring.SpringContextInnerContainer.getBeanByType(className)
