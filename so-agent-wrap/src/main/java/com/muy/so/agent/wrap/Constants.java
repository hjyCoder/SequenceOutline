...
public class Constants {
     ...
     * 方法调用日志上传
     */
    public static final String DEFAULT_CALL_LINK_TREE_INVOKE_LOG_BROADCASTER = "broadcaster.callLink.treeInvokeLog.url";

    /**
     * 方法调用链路上传
     */
    public static final String DEFAULT_CALL_LINK_TREE_INVOKE_BROADCASTER = "broadcaster.callLink.treeInvoke.url";

    /**
     * 查询Mock配置链接
     */
    public static final String DEFAULT_CONFIG_MOCK_DATASOURCE = "repeat.config.mock.url";
