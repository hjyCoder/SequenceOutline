...
//        mapper.configure(DeserializationFeature.FAIL_ON_INVALID_SUBTYPE, false);
    ...
    public static <T> T toJavaObject(String value, TypeReference<T> valueTypeRef) {
        try {
            ...
            LOGGER.error(String.format("toJavaObject value = %s, tClass = %s", value, valueTypeRef), e);
        }
        return null;
    }
    ...
    public static String sortJsonIncludeList(String json) {
        try {
            ...
            LOGGER.error(String.format("%s, msg = %s", ex.getClass(), ex.getMessage()));
            return json;
        }
    }
    ...
    private static String sortJsonList(String json) {
        try {
            ...
            try {
                ...
                LOGGER.error(String.format("%s, msg = %s", exc.getClass(), exc.getMessage()));
                return json;
            }
        }
    }
